...
PLUGIN_API void CloseDriver() { CloseDriver_orig(); }
PLUGIN_API void DefDriverProc() { DefDriverProc_orig(); }
PLUGIN_API void DriverCallback() { DriverCallback_orig(); }
PLUGIN_API void DrvGetModuleHandle() { DrvGetModuleHandle_orig(); }
PLUGIN_API void GetDriverModuleHandle() { GetDriverModuleHandle_orig(); }
PLUGIN_API void NotifyCallbackData() { NotifyCallbackData_orig(); }
PLUGIN_API void OpenDriver() { OpenDriver_orig(); }
PLUGIN_API void PlaySound() { PlaySound_orig(); }
PLUGIN_API void PlaySoundA() { PlaySoundA_orig(); }
PLUGIN_API void PlaySoundW() { PlaySoundW_orig(); }
PLUGIN_API void SendDriverMessage() { SendDriverMessage_orig(); }
PLUGIN_API void WOW32DriverCallback() { WOW32DriverCallback_orig(); }
PLUGIN_API void WOW32ResolveMultiMediaHandle() { WOW32ResolveMultiMediaHandle_orig(); }
PLUGIN_API void WOWAppExit() { WOWAppExit_orig(); }
PLUGIN_API void aux32Message() { aux32Message_orig(); }
PLUGIN_API void auxGetDevCapsA() { auxGetDevCapsA_orig(); }
PLUGIN_API void auxGetDevCapsW() { auxGetDevCapsW_orig(); }
PLUGIN_API void auxGetNumDevs() { auxGetNumDevs_orig(); }
PLUGIN_API void auxGetVolume() { auxGetVolume_orig(); }
PLUGIN_API void auxOutMessage() { auxOutMessage_orig(); }
PLUGIN_API void auxSetVolume() { auxSetVolume_orig(); }
PLUGIN_API void joy32Message() { joy32Message_orig(); }
PLUGIN_API void joyConfigChanged() { joyConfigChanged_orig(); }
PLUGIN_API void joyGetDevCapsA() { joyGetDevCapsA_orig(); }
PLUGIN_API void joyGetDevCapsW() { joyGetDevCapsW_orig(); }
PLUGIN_API void joyGetNumDevs() { joyGetNumDevs_orig(); }
PLUGIN_API void joyGetPos() { joyGetPos_orig(); }
PLUGIN_API void joyGetPosEx() { joyGetPosEx_orig(); }
PLUGIN_API void joyGetThreshold() { joyGetThreshold_orig(); }
PLUGIN_API void joyReleaseCapture() { joyReleaseCapture_orig(); }
PLUGIN_API void joySetCapture() { joySetCapture_orig(); }
PLUGIN_API void joySetThreshold() { joySetThreshold_orig(); }
PLUGIN_API void mci32Message() { mci32Message_orig(); }
PLUGIN_API void mciDriverNotify() { mciDriverNotify_orig(); }
PLUGIN_API void mciDriverYield() { mciDriverYield_orig(); }
PLUGIN_API void mciExecute() { mciExecute_orig(); }
PLUGIN_API void mciFreeCommandResource() { mciFreeCommandResource_orig(); }
PLUGIN_API void mciGetCreatorTask() { mciGetCreatorTask_orig(); }
PLUGIN_API void mciGetDeviceIDA() { mciGetDeviceIDA_orig(); }
PLUGIN_API void mciGetDeviceIDFromElementIDA() { mciGetDeviceIDFromElementIDA_orig(); }
PLUGIN_API void mciGetDeviceIDFromElementIDW() { mciGetDeviceIDFromElementIDW_orig(); }
PLUGIN_API void mciGetDeviceIDW() { mciGetDeviceIDW_orig(); }
PLUGIN_API void mciGetDriverData() { mciGetDriverData_orig(); }
PLUGIN_API void mciGetErrorStringA() { mciGetErrorStringA_orig(); }
PLUGIN_API void mciGetErrorStringW() { mciGetErrorStringW_orig(); }
PLUGIN_API void mciGetYieldProc() { mciGetYieldProc_orig(); }
PLUGIN_API void mciLoadCommandResource() { mciLoadCommandResource_orig(); }
PLUGIN_API void mciSendCommandA() { mciSendCommandA_orig(); }
PLUGIN_API void mciSendCommandW() { mciSendCommandW_orig(); }
PLUGIN_API void mciSendStringA() { mciSendStringA_orig(); }
PLUGIN_API void mciSendStringW() { mciSendStringW_orig(); }
PLUGIN_API void mciSetDriverData() { mciSetDriverData_orig(); }
PLUGIN_API void mciSetYieldProc() { mciSetYieldProc_orig(); }
PLUGIN_API void mid32Message() { mid32Message_orig(); }
PLUGIN_API void midiConnect() { midiConnect_orig(); }
PLUGIN_API void midiDisconnect() { midiDisconnect_orig(); }
PLUGIN_API void midiInAddBuffer() { midiInAddBuffer_orig(); }
PLUGIN_API void midiInClose() { midiInClose_orig(); }
PLUGIN_API void midiInGetDevCapsA() { midiInGetDevCapsA_orig(); }
PLUGIN_API void midiInGetDevCapsW() { midiInGetDevCapsW_orig(); }
PLUGIN_API void midiInGetErrorTextA() { midiInGetErrorTextA_orig(); }
PLUGIN_API void midiInGetErrorTextW() { midiInGetErrorTextW_orig(); }
PLUGIN_API void midiInGetID() { midiInGetID_orig(); }
PLUGIN_API void midiInGetNumDevs() { midiInGetNumDevs_orig(); }
PLUGIN_API void midiInMessage() { midiInMessage_orig(); }
PLUGIN_API void midiInOpen() { midiInOpen_orig(); }
PLUGIN_API void midiInPrepareHeader() { midiInPrepareHeader_orig(); }
PLUGIN_API void midiInReset() { midiInReset_orig(); }
PLUGIN_API void midiInStart() { midiInStart_orig(); }
PLUGIN_API void midiInStop() { midiInStop_orig(); }
PLUGIN_API void midiInUnprepareHeader() { midiInUnprepareHeader_orig(); }
PLUGIN_API void midiOutCacheDrumPatches() { midiOutCacheDrumPatches_orig(); }
PLUGIN_API void midiOutCachePatches() { midiOutCachePatches_orig(); }
PLUGIN_API void midiOutClose() { midiOutClose_orig(); }
PLUGIN_API void midiOutGetDevCapsA() { midiOutGetDevCapsA_orig(); }
PLUGIN_API void midiOutGetDevCapsW() { midiOutGetDevCapsW_orig(); }
PLUGIN_API void midiOutGetErrorTextA() { midiOutGetErrorTextA_orig(); }
PLUGIN_API void midiOutGetErrorTextW() { midiOutGetErrorTextW_orig(); }
PLUGIN_API void midiOutGetID() { midiOutGetID_orig(); }
PLUGIN_API void midiOutGetNumDevs() { midiOutGetNumDevs_orig(); }
PLUGIN_API void midiOutGetVolume() { midiOutGetVolume_orig(); }
PLUGIN_API void midiOutLongMsg() { midiOutLongMsg_orig(); }
PLUGIN_API void midiOutMessage() { midiOutMessage_orig(); }
PLUGIN_API void midiOutOpen() { midiOutOpen_orig(); }
PLUGIN_API void midiOutPrepareHeader() { midiOutPrepareHeader_orig(); }
PLUGIN_API void midiOutReset() { midiOutReset_orig(); }
PLUGIN_API void midiOutSetVolume() { midiOutSetVolume_orig(); }
PLUGIN_API void midiOutShortMsg() { midiOutShortMsg_orig(); }
PLUGIN_API void midiOutUnprepareHeader() { midiOutUnprepareHeader_orig(); }
PLUGIN_API void midiStreamClose() { midiStreamClose_orig(); }
PLUGIN_API void midiStreamOpen() { midiStreamOpen_orig(); }
PLUGIN_API void midiStreamOut() { midiStreamOut_orig(); }
PLUGIN_API void midiStreamPause() { midiStreamPause_orig(); }
PLUGIN_API void midiStreamPosition() { midiStreamPosition_orig(); }
PLUGIN_API void midiStreamProperty() { midiStreamProperty_orig(); }
PLUGIN_API void midiStreamRestart() { midiStreamRestart_orig(); }
PLUGIN_API void midiStreamStop() { midiStreamStop_orig(); }
PLUGIN_API void mixerClose() { mixerClose_orig(); }
PLUGIN_API void mixerGetControlDetailsA() { mixerGetControlDetailsA_orig(); }
PLUGIN_API void mixerGetControlDetailsW() { mixerGetControlDetailsW_orig(); }
PLUGIN_API void mixerGetDevCapsA() { mixerGetDevCapsA_orig(); }
PLUGIN_API void mixerGetDevCapsW() { mixerGetDevCapsW_orig(); }
PLUGIN_API void mixerGetID() { mixerGetID_orig(); }
PLUGIN_API void mixerGetLineControlsA() { mixerGetLineControlsA_orig(); }
PLUGIN_API void mixerGetLineControlsW() { mixerGetLineControlsW_orig(); }
PLUGIN_API void mixerGetLineInfoA() { mixerGetLineInfoA_orig(); }
PLUGIN_API void mixerGetLineInfoW() { mixerGetLineInfoW_orig(); }
PLUGIN_API void mixerGetNumDevs() { mixerGetNumDevs_orig(); }
PLUGIN_API void mixerMessage() { mixerMessage_orig(); }
PLUGIN_API void mixerOpen() { mixerOpen_orig(); }
PLUGIN_API void mixerSetControlDetails() { mixerSetControlDetails_orig(); }
PLUGIN_API void mmDrvInstall() { mmDrvInstall_orig(); }
PLUGIN_API void mmGetCurrentTask() { mmGetCurrentTask_orig(); }
PLUGIN_API void mmTaskBlock() { mmTaskBlock_orig(); }
PLUGIN_API void mmTaskCreate() { mmTaskCreate_orig(); }
PLUGIN_API void mmTaskSignal() { mmTaskSignal_orig(); }
PLUGIN_API void mmTaskYield() { mmTaskYield_orig(); }
PLUGIN_API void mmioAdvance() { mmioAdvance_orig(); }
PLUGIN_API void mmioAscend() { mmioAscend_orig(); }
PLUGIN_API void mmioClose() { mmioClose_orig(); }
PLUGIN_API void mmioCreateChunk() { mmioCreateChunk_orig(); }
PLUGIN_API void mmioDescend() { mmioDescend_orig(); }
PLUGIN_API void mmioFlush() { mmioFlush_orig(); }
PLUGIN_API void mmioGetInfo() { mmioGetInfo_orig(); }
PLUGIN_API void mmioInstallIOProcA() { mmioInstallIOProcA_orig(); }
PLUGIN_API void mmioInstallIOProcW() { mmioInstallIOProcW_orig(); }
PLUGIN_API void mmioOpenA() { mmioOpenA_orig(); }
PLUGIN_API void mmioOpenW() { mmioOpenW_orig(); }
PLUGIN_API void mmioRead() { mmioRead_orig(); }
PLUGIN_API void mmioRenameA() { mmioRenameA_orig(); }
PLUGIN_API void mmioRenameW() { mmioRenameW_orig(); }
PLUGIN_API void mmioSeek() { mmioSeek_orig(); }
PLUGIN_API void mmioSendMessage() { mmioSendMessage_orig(); }
PLUGIN_API void mmioSetBuffer() { mmioSetBuffer_orig(); }
PLUGIN_API void mmioSetInfo() { mmioSetInfo_orig(); }
PLUGIN_API void mmioStringToFOURCCA() { mmioStringToFOURCCA_orig(); }
PLUGIN_API void mmioStringToFOURCCW() { mmioStringToFOURCCW_orig(); }
PLUGIN_API void mmioWrite() { mmioWrite_orig(); }
PLUGIN_API void mmsystemGetVersion() { mmsystemGetVersion_orig(); }
PLUGIN_API void mod32Message() { mod32Message_orig(); }
PLUGIN_API void mxd32Message() { mxd32Message_orig(); }
PLUGIN_API void sndPlaySoundA() { sndPlaySoundA_orig(); }
PLUGIN_API void sndPlaySoundW() { sndPlaySoundW_orig(); }
PLUGIN_API void tid32Message() { tid32Message_orig(); }
PLUGIN_API void timeBeginPeriod() { timeBeginPeriod_orig(); }
PLUGIN_API void timeEndPeriod() { timeEndPeriod_orig(); }
PLUGIN_API void timeGetDevCaps() { timeGetDevCaps_orig(); }
PLUGIN_API void timeGetSystemTime() { timeGetSystemTime_orig(); }
PLUGIN_API void timeGetTime() { timeGetTime_orig(); }
PLUGIN_API void timeKillEvent() { timeKillEvent_orig(); }
PLUGIN_API void timeSetEvent() { timeSetEvent_orig(); }
PLUGIN_API void waveInAddBuffer() { waveInAddBuffer_orig(); }
PLUGIN_API void waveInClose() { waveInClose_orig(); }
PLUGIN_API void waveInGetDevCapsA() { waveInGetDevCapsA_orig(); }
PLUGIN_API void waveInGetDevCapsW() { waveInGetDevCapsW_orig(); }
PLUGIN_API void waveInGetErrorTextA() { waveInGetErrorTextA_orig(); }
PLUGIN_API void waveInGetErrorTextW() { waveInGetErrorTextW_orig(); }
PLUGIN_API void waveInGetID() { waveInGetID_orig(); }
PLUGIN_API void waveInGetNumDevs() { waveInGetNumDevs_orig(); }
PLUGIN_API void waveInGetPosition() { waveInGetPosition_orig(); }
PLUGIN_API void waveInMessage() { waveInMessage_orig(); }
PLUGIN_API void waveInOpen() { waveInOpen_orig(); }
PLUGIN_API void waveInPrepareHeader() { waveInPrepareHeader_orig(); }
PLUGIN_API void waveInReset() { waveInReset_orig(); }
PLUGIN_API void waveInStart() { waveInStart_orig(); }
PLUGIN_API void waveInStop() { waveInStop_orig(); }
PLUGIN_API void waveInUnprepareHeader() { waveInUnprepareHeader_orig(); }
PLUGIN_API void waveOutBreakLoop() { waveOutBreakLoop_orig(); }
PLUGIN_API void waveOutClose() { waveOutClose_orig(); }
PLUGIN_API void waveOutGetDevCapsA() { waveOutGetDevCapsA_orig(); }
PLUGIN_API void waveOutGetDevCapsW() { waveOutGetDevCapsW_orig(); }
PLUGIN_API void waveOutGetErrorTextA() { waveOutGetErrorTextA_orig(); }
PLUGIN_API void waveOutGetErrorTextW() { waveOutGetErrorTextW_orig(); }
PLUGIN_API void waveOutGetID() { waveOutGetID_orig(); }
PLUGIN_API void waveOutGetNumDevs() { waveOutGetNumDevs_orig(); }
PLUGIN_API void waveOutGetPitch() { waveOutGetPitch_orig(); }
PLUGIN_API void waveOutGetPlaybackRate() { waveOutGetPlaybackRate_orig(); }
PLUGIN_API void waveOutGetPosition() { waveOutGetPosition_orig(); }
PLUGIN_API void waveOutGetVolume() { waveOutGetVolume_orig(); }
PLUGIN_API void waveOutMessage() { waveOutMessage_orig(); }
PLUGIN_API void waveOutOpen() { waveOutOpen_orig(); }
PLUGIN_API void waveOutPause() { waveOutPause_orig(); }
PLUGIN_API void waveOutPrepareHeader() { waveOutPrepareHeader_orig(); }
PLUGIN_API void waveOutReset() { waveOutReset_orig(); }
PLUGIN_API void waveOutRestart() { waveOutRestart_orig(); }
PLUGIN_API void waveOutSetPitch() { waveOutSetPitch_orig(); }
PLUGIN_API void waveOutSetPlaybackRate() { waveOutSetPlaybackRate_orig(); }
PLUGIN_API void waveOutSetVolume() { waveOutSetVolume_orig(); }
PLUGIN_API void waveOutUnprepareHeader() { waveOutUnprepareHeader_orig(); }
PLUGIN_API void waveOutWrite() { waveOutWrite_orig(); }
PLUGIN_API void wid32Message() { wid32Message_orig(); }
PLUGIN_API void wod32Message() { wod32Message_orig(); }
